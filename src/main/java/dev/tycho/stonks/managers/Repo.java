...
public class Repo extends SpigotModule {
  ...
  public HoldingsAccount createHoldingsAccount(Company company, String name, Player player) {
    HoldingsAccount ha = new HoldingsAccount(0, name, UUID.randomUUID(), company.pk, false, new ArrayList<>(), new ArrayList<>());
  ...
  public CompanyAccount createCompanyAccount(Company company, String name) {
    CompanyAccount ca = new CompanyAccount(0, name, UUID.randomUUID(), company.pk, false, new ArrayList<>(), 0);
  ...
  public Account renameAccount(Account account, String newName) {
    ReturningAccountVisitor<Account> visitor = new ReturningAccountVisitor<Account>() {
      @Override
      public void visit(CompanyAccount a) {
        CompanyAccount ca = new CompanyAccount(a.pk, newName, a.uuid, a.companyPk, false, a.services, a.balance);
      ...
      @Override
      public void visit(HoldingsAccount a) {
        HoldingsAccount ha = new HoldingsAccount(a.pk, newName, a.uuid, a.companyPk, false, a.services, a.holdings);
  ...
  public Account payAccount(UUID player, String message, Account account, double amount) {
    ReturningAccountVisitor<Account> visitor = new ReturningAccountVisitor<Account>() {
      @Override
      public void visit(CompanyAccount a) {
        CompanyAccount ca = new CompanyAccount(a.pk, a.name, a.uuid, a.companyPk, false, a.services, a.balance + amount);
        companyAccountStore.save(ca);
        val = ca;
      }
      ...
      @Override
      public void visit(HoldingsAccount a) {
        HoldingsAccount ha = new HoldingsAccount(a.pk, a.name, a.uuid, a.companyPk, false, a.services, a.holdings);
